...
-- Migration: 001_create_clinical_tables.sql
-- Description: Creates clinical_examinations, tooth_findings, treatment_plans,
--              treatment_procedures, and clinical_progress_notes tables.
-- =============================================================================
...
CREATE INDEX idx_clinical_examinations_patient ON clinical_examinations (patient_id);
CREATE INDEX idx_clinical_examinations_dentist ON clinical_examinations (dentist_id);
CREATE INDEX idx_clinical_examinations_date ON clinical_examinations (examination_date);
CREATE INDEX idx_clinical_examinations_appointment ON clinical_examinations (appointment_id);
...
CREATE INDEX idx_tooth_findings_exam ON tooth_findings (examination_id);
CREATE INDEX idx_tooth_findings_tooth ON tooth_findings (tooth_number);
...
CREATE INDEX idx_treatment_plans_exam ON treatment_plans (examination_id);
...
CREATE INDEX idx_treatment_procedures_plan ON treatment_procedures (treatment_plan_id);
CREATE INDEX idx_treatment_procedures_status ON treatment_procedures (status);
CREATE INDEX idx_treatment_procedures_tooth ON treatment_procedures (tooth_number);
...
CREATE INDEX idx_progress_notes_plan ON clinical_progress_notes (treatment_plan_id);
CREATE INDEX idx_progress_notes_procedure ON clinical_progress_notes (treatment_procedure_id);
