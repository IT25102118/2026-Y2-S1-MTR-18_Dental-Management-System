...
/**
 * Request payload for updating catalog master data of an existing inventory item.
 * Note: itemCode is immutable and currentQuantity can only be modified via stock movements.
 */
public class UpdateInventoryItemRequest {
    ...
    public UpdateInventoryItemRequest(String name, String category, String unit,
